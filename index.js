/**
 * B͎E͎N͎Z  C͎O͎M͎P͎A͎N͎Y͎ X͎M͎D͎ - A WhatsApp Bot
 * Copyright (c) 2025 ALPHA-KING-TECH 
 * 
 ...
 * - Pair Code implementation inspired by ALPHA-KING 
 */
require('./settings')
...
✅ Status: Online and Ready!
            ...
            console.log(chalk.magenta(`${global.themeemoji || '•'} CREDIT: ALPHA-KING͎`))
            console.log(chalk.green(`${global.themeemoji || '•'} Benz Xmd is Connected Successfully! ✅`))
        }
        if (
            connection === "close" &&
            lastDisconnect &&
